...
<tbody>
    <?php if(count($questions) > 0): ?>
        ...
        <tr>
            ...
            <td>
                <a href="#" class="ansButton" data-id="<?php echo e($question->id); ?>" data-toggle="modal" data-target="#showAnsModal">Lihat jawaban</a>
            </td>
            <td>
                <button class="btn btn-info editButton" data-id="<?php echo e($question->id); ?>" data-toggle="modal" data-target="#editQnaModal">Edit</button>
            </td>
            <td>
                <button class="btn btn-danger deleteButton" data-id="<?php echo e($question->id); ?>" data-toggle="modal" data-target="#deleteQnaModal">Delete</button>
            </td>
        </tr>
...
<?php echo $__env->make('layout/admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project-PKL\web-pkl\resources\views/admin/qnaDashboard.blade.php ENDPATH**/ ?>