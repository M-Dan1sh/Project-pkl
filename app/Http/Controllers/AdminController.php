...
class AdminController extends Controller
{
    ...
    public function addSubject(Request $request)
    {
        try{
            ...
            return response()->json(['success'=>true,'msg'=>'Mapel Sukses di Tambahkan']);
    ...
    public function editSubject(Request $request)
    {
        try{
            ...
            $subject->save();
            return response()->json(['success'=>true,'msg'=>'Mapel Sukses di Update']);
    ...
    public function deleteSubject(Request $request)
    {
        try{
            ...
            return response()->json(['success'=>true,'msg'=>'Mapel Sukses di Delete']);
    ...
    public function addExam(Request $request)
    {
        try{
            ...
            return response()->json(['success'=>true,'msg'=>'Ujian sukses di tambahkan']);
    ...
    public function updateExam(Request $request)
    {
        try{
            ...
            $exam->save();
            return response()->json(['success'=>true,'msg'=>'Ujian berhasil di update']);
        }catch(\Exception $e){
            return response()->json(['success'=>false,'msg'=>$e->getMessage()]);
        };
    }
    ...
    public function deleteExam(Request $request)
    {
        try{
            ...
            return response()->json(['success'=>true,'msg'=>'Ujian sukses di hapus!']);
    ...
    public function deleteAns(Request $request)
    {
        ...
        return response()->json(['success'=>true,'msg'=>'Answer deleted successfullly!']);
    }
    ...
    public function deleteQna(Request $request)
    {
        ...
        return response()->json(['success'=>true, 'msg' =>'Q&A Sukses di delete']);
    }
    ...
    public function addStudent(Request $request)
    {
        try {
            ...
            $data['title'] = "Student Registrasi di oes";
    ...
    public function getQuestions (Request $request)
    {
        try {
            ...
            if(count($questions) > 0){
                ...
                return response()->json(['success'=>false,'msg'=>'pertanyaan tidak ditemukan']);    
            }
        }catch(\Exception $e){
            return response()->json(['success'=>false,'msg'=>$e->getMessage()]);
        };
    ...
    public function updateMarks(Request $request)
    {
        try {
            ...
            return response()->json(['success'=>true,'msg'=>'Marks sudah di upated']);
    ...
    public function importQna(Request $request)
    {
        try {
            ...
            return response()->json(['success'=>true,'msg'=>'Import sukses danil suka sama fatma']);
